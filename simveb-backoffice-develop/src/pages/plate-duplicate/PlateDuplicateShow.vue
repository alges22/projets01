<script setup lang="ts">
	import PlateDuplicateMainView from "/@src/pages/plate-duplicate/steps/MainView.vue";
	import PlateDuplicateAffectationView from "/@src/pages/plate-duplicate/steps/AffectationView.vue";
	import PlateDuplicateImmatriculationView from "/@src/pages/plate-duplicate/steps/ImmatriculationView.vue";
	...
	const { demand } = storeToRefs(duplicateStore);
		...
		<div class="tab-details">
			<div class="tabs-wrapper">
				...
				<div v-if="tab === 'pending'" class="tab-content is-active">
					<PlateDuplicateMainView :demand-id="demandId" />
				</div>
				<div v-if="tab == 'assigned'" class="tab-content is-active">
					<PlateDuplicateAffectationView :demand-id="demandId" />
				</div>
				<div v-if="tab == 'preview'" class="tab-content is-active">
					<PlateDuplicateImmatriculationView :demand-id="demandId" />
				</div>
			</div>
		</div>
	</div>
