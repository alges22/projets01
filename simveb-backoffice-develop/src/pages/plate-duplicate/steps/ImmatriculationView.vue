<script setup lang="ts">
	...
	onMounted(() => {
		if (!demand.value.id) {
			duplicateStore.fetchDemand(props.demandId);
		}
	});
			...
			<VCard class="side-card">
				...
				<div v-if="demand" class="card-inner is-size-6-5 columns is-multiline">
					<div class="column is-half">
						...
						<square-plate-view
							v-if="demand.immatriculation"
							:bg-color="demand.immatriculation.immatriculation_demand.plate_color.color_code"
							:text-color="demand.immatriculation.immatriculation_demand.plate_color.text_color"
							:immatriculation-number="demand.immatriculation.number"
						/>
					</div>
					<div class="column is-half">
						<div class="mb-2 is-flex is-justify-content-center is-uppercase">
					...
					<div class="column is-12 mt-2">
						<div class="is-flex is-justify-content-space-between">
							<div class="is-flex is-flex-wrap-wrap align-items is-align-content-center">
								<span>
									Immatriculation:
									{{ demand.immatriculation.formatLabel }}
								</span>
							</div>
