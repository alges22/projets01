<script setup lang="ts">
	...
	onMounted(() => {
		if (!demand.value.id) {
			...
			immatriculation.value = demand.value.immatriculation;
		}
	});
	...
	<div class="columns tab-details-inner is-multiline">
		<div class="column is-12">
			<VCard class="side-card">
				...
				<div v-if="immatriculation" class="card-inner is-size-6-5">
							...
							<div class="is-flex is-justify-content-center">
								<div class="gray-card-front">
									...
									<div class="content">
										...
										<div>
											<span>N° {{ immatriculation.gray_card.number }}</span>
										</div>
									</div>
								</div>
							</div>
										...
										<div class="content-info px-4">
											<div class="columns is-multiline">
												...
												<div class="column is-half content-info-row">
													...
													<div class="">
														<span class="content-info-subtitle">{{ owner.lastname }}</span>
													</div>
												</div>
												<div class="column is-half content-info-row">
													<div class="">
												...
												>
													...
													<span>{{ immatriculation.gray_card.number }}</span>
												</div>
											</div>
										</div>
									</div>
