<template>
	<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 tab-details-inner">
		<UserInfoCard title="Informations du vendeur" :user="demandInfo.model.vehicle_owner.identity" />

		<UserInfoCard title="Informations de l'acheteur" :user="demandInfo.model.new_owner" />

		<VCard class="side-card">
			<div class="card-head">
				<h3 class="font-bold text-light">Certificat de vente</h3>
			</div>
