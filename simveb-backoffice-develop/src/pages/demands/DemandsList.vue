<template>
	<div class="page-content-inner">
		...
		>
			...
			<template #buttons>
				<VButton color="primary" raised @click="exportModalOpen = true"> Exporter </VButton>
			</template>
		</DataTable>

		<DemandsExport :open="exportModalOpen" @close="exportModalOpen = false" />
	</div>
</template>
...
<script setup lang="ts">
	...
	import DemandsExport from "/@src/pages/demands/DemandsExport.vue";
	...
	const getItems = async (metadata) => {
		url.value = "/admin-demands";
		await crudStore.fetchRows(metadata);
	};

	const headers = [
		{ title: "Référence", key: "reference", sortable: true, idField: true },
