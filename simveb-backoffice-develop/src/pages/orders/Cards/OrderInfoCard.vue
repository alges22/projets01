	...
	<VCard class="side-card">
		...
		<div class="card-inner is-one-third">
			<div class="columns">
				...
				<div class="column">{{ order.reference }}</div>
			</div>
			<div class="columns">
				<div class="column is-half">
					<span class="has-text-weight-semibold">Montant total</span>
				</div>
				<div class="column">{{ order.amount }} XOF</div>
			</div>
			<div class="columns">
				<div class="column is-half">
			...
			<div class="columns">
				...
				<div class="column">{{ order.payment_status }}</div>
			</div>
			<div class="columns">
				<div class="column is-half">
					<span class="has-text-weight-semibold">Nombre de demande</span>
				</div>
				<div v-if="order.demands" class="column">{{ order.demands.length }}</div>
			</div>
			<div class="columns">
				<div class="column is-half">
