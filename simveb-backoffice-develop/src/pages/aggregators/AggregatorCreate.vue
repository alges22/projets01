		...
		<template #form-body>
			<div class="columns is-centered pt-2">
				<div class="column is-8">
					...
					<VField label="Clé publique" horizontal>
						<VControl fullwidth :errors="errors.publicKey || []">
							<VInput v-model="publicKey" type="text" placeholder="Clé publique" name="label" required />
						</VControl>
					</VField>
					<VField label="Clé privé" horizontal>
						<VControl fullwidth :errors="errors.privateKey || []">
							<VInput v-model="privateKey" type="text" placeholder="Clé privé" name="label" required />
						</VControl>
					</VField>
