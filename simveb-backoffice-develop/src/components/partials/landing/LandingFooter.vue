			...
			<div class="footer-head">
				...
				<div class="head-action">
					<div class="buttons">
						...
						<a target="_blank" href="https://go.cssninja.io/discord" class="button chat-button">
				...
				<div class="column is-4">
					...
					<div>
						<span class="moto">
							...
							<a href="https://cssninja.io" target="_blank" class="has-text-primary"> CSS Ninja. </a>
						</span>
					...
					<div class="columns is-flex-tablet-p">
						...
						<div class="column">
							<ul class="footer-column">
								...
								<li class="column-item">
									<a href="https://cssninja.io/faq/github-access" target="_blank"> GitHub Access </a>
								</li>
								<li class="column-item">
						...
						<div class="column">
							<ul class="footer-column">
								...
								<li class="column-item">
									<a href="https://cssninja.io/faq/support" target="_blank"> Support center </a>
								</li>
								<li class="column-item">
						...
						<div class="column">
							<ul class="footer-column">
								...
								<li class="column-item">
									<a href="https://cssninja.io/company/contact" target="_blank"> Contact us </a>
								</li>
							</ul>
						</div>
					</div>
