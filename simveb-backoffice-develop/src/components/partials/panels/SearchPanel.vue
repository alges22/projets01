<script setup lang="ts">
	...
	const filteredData = computed(() => {
		...
		return Object.values(popovers).filter((user) => {
			return (
				user.fullName.match(new RegExp(filter.value, "i")) || user.position.match(new RegExp(filter.value, "i"))
			);
		});
	});
						...
						<VBlock title="Browser Support" subtitle="Blog post" center>
							<template #icon>
								<VIconBox size="small" color="info" rounded>
									<i aria-hidden="true" class="fa-light fa-chrome"></i>
								</VIconBox>
							</template>
						</VBlock>
						<VBlock title="Twitch API" subtitle="Blog post" center>
							<template #icon>
								<VIconBox size="small" color="orange" rounded>
									<i aria-hidden="true" class="fa-light fa-tv"></i>
								</VIconBox>
							</template>
						</VBlock>
						<VBlock title="Browser Support" subtitle="Blog post" center>
							<template #icon>
								<VIconBox size="small" color="green" rounded>
									<i aria-hidden="true" class="fa-light fa-twitter"></i>
								</VIconBox>
							</template>
						</VBlock>
					</div>
