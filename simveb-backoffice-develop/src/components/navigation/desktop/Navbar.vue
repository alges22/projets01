				...
				<slot name="links">
					<div class="centered-links">
						<a href="/" class="centered-link centered-link-toggle">
							<i aria-hidden="true" class="fa-light fa-activity" />
							<span>Homepage</span>
						</a>
					</div>
              ...
              >
                <div class="is-trigger">
                  ...
                  >
                    <span>Homepage</span>
                    <span class="caret">
                      <i aria-hidden="true" class="fa-light fa-chevron-down"></i>
                    </span>
                  </a>
                </div>
              </div>
...
<style lang="scss">
	...
	.main-sidebar {
		&.is-panel-open ~ {
			.navbar-navbar .left,
			.view-wrapper .page-content-wrapper {
				margin-left: calc(200px + 50px - 20px);
			}
		}
		&.is-panel-close ~ {
			.navbar-navbar .left,
...
========================================================================== */
	...
	@media (width <= 1280px) {
		.navbar-navbar .navbar-navbar-inner .right .user-info {
