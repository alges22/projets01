<script lang="ts">
	...
	import VPlaceload, { type VPlaceloadProps } from "/@src/components/base/loader/VPlaceload.vue";
	...
	export default defineComponent({
		...
		setup(props) {
			...
			watchEffect(async () => {
				...
				const theme = {
					light: typeof props.shiki.theme === "string" ? props.shiki.theme : props.shiki.theme.light,
					dark: typeof props.shiki.theme === "string" ? props.shiki.theme : props.shiki.theme.dark,
				};
				...
				processor.value = unified()
					...
					.use(rehypeSanitize, {
						...
						attributes: {
							...
							span: [...(defaultSchema.attributes?.span || []), ["className"], ["style"], ["dataHint"]],
						},
					})
