<script setup lang="ts">
	...
	export type VDropdownColor = string;
...
<template>
	<div
		...
		:class="[
			...
			...(typeof props.classes?.wrapper === 'string' ? [props.classes?.wrapper] : props.classes?.wrapper ?? ''),
		]"
		class="dropdown"
	>
		<slot name="button" v-bind="dropdown">
			...
			>
				<VIcon :icon="props.icon" :color="props.color" />
			</a>
