		...
		<div class="columns">
			<div class="column is-9">
				...
				<div class="booking-bar-wrapper">
					...
					<div class="booking-bar-info">
						<i aria-hidden="true" class="fa-light fa-plane-alt"></i>
						<div class="inner">
			...
			<div class="column is-3">
				...
				<UIWidget class="picker-widget">
					<template #header>
						<div class="widget-toolbar">
							<div class="left">
								<a class="action-icon">
									<i aria-hidden="true" class="fa-light fa-chevron-right ltr-hidden" />
									<i aria-hidden="true" class="fa-light fa-chevron-left rtl-hidden" />
								</a>
							</div>
							<div class="center">
								<h3>October 2020</h3>
							...
							<div class="right">
								<a class="action-icon">
									<i aria-hidden="true" class="fa-light fa-chevron-right rtl-hidden" />
									<i aria-hidden="true" class="fa-light fa-chevron-left ltr-hidden" />
								</a>
							</div>
						</div>
					</template>
				...
				<div class="filters-card">
					<a class="button v-button is-primary is-fullwidth is-bold is-raised"> Add To Favorites </a>
					...
					<div class="checkboxes-list">
						<div class="field">
							...
							<div class="control">
								<VCheckbox v-model="options" value="No Stops" label="No Stops" color="primary" circle />
							</div>
							<div class="control">
								<VCheckbox v-model="options" value="1 Stop" label="1 Stop" color="primary" circle />
							</div>
							<div class="control">
								<VCheckbox v-model="options" value="2 Stops" label="2 Stops" color="primary" circle />
							</div>
						</div>
					</div>
					...
					<div class="checkboxes-list">
						<div class="field">
							...
							<div class="control">
								<VCheckbox v-model="options" value="None" label="None" color="primary" circle />
							</div>
						</div>
					</div>
				</div>
