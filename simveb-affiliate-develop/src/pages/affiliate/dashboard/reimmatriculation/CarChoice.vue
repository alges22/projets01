<template>
	<div class="intro-y flex items-center mt-8">
		<h2 class="text-lg font-semibold mr-auto">Sélectionnez le véhicule que vous souhaitez réimmatriculer</h2>
	</div>
	...
	<div class="intro-y col-span-12">
		<div class="text-right mt-4">
			...
			<button
				...
				type="button"
				@click="$router.push('/affiliate/dashboard/reimmatriculation/VehicleInfo')"
			>
				Suivant
			</button>
		</div>
