	...
	<div class="content">
		<div class="top-bar -mx-4 px-4 md:mx-0 md:px-0 md:align-baseline mt-4">
			<nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
				<ol class="breadcrumb">
					<li class="breadcrumb-item">Tableau de bord / Policier aux frontières</li>
				</ol>
			</nav>
		...
		<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
			<div class="w-full sm:w-auto flex mt-4 sm:mt-0 ml-auto">
				<button class="btn btn-outline-danger shadow-md mr-4">Signaler une voiture</button>
				<router-link class="btn btn-primary shadow-md mr-2" to="/police/dashboard/register/RegisterType">
