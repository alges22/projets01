	...
	<div class="grid grid-cols-12 gap-6 mt-5">
		<div class="intro-y col-span-12">
			<div class="intro-y box p-5">
				...
				<div class="sm:grid grid-cols-2 gap-8 mt-4">
					<div>
						<label class="form-label" for="crud-form-1">Numéro d'immatriculation</label>
						<input
							id="crud-form-1"
							class="form-control w-full"
							placeholder="Input text"
					...
					<div>
						<label class="form-label" for="crud-form-1">Pays d'immatriculation</label>
						<select aria-label="Default select example" class="form-select">
							<option>{{ isoToEmoji("BJ") }}&nbsp;&nbsp;&nbsp;&nbsp;Bénin</option>
							<option>{{ isoToEmoji("NG") }}&nbsp;&nbsp;&nbsp;&nbsp;Nigeria</option>
							<option>{{ isoToEmoji("TG") }}&nbsp;&nbsp;&nbsp;&nbsp;Togo</option>
							<option>{{ isoToEmoji("GH") }}&nbsp;&nbsp;&nbsp;&nbsp;Ghana</option>
							<option>{{ isoToEmoji("CI") }}&nbsp;&nbsp;&nbsp;&nbsp;Côte d'Ivoire</option>
							<option>{{ isoToEmoji("BF") }}&nbsp;&nbsp;&nbsp;&nbsp;Burkina Faso</option>
							<option>{{ isoToEmoji("NE") }}&nbsp;&nbsp;&nbsp;&nbsp;Niger</option>
						</select>
					</div>
				</div>
				...
				<div class="sm:grid grid-cols-2 gap-8 mt-4">
					<div>
						<label class="form-label" for="crud-form-1">Numéro de la carte grise</label>
						<input
							id="crud-form-1"
							class="form-control w-full"
							placeholder="Input text"
					...
					<div>
						<label class="form-label">Photo de la carte grise</label>
						<label
							class="flex rounded-lg border bg-[#F4F6F9] px-4 py-2 items-center cursor-pointer focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500"
							for="file-upload"
						>
				...
				<div class="sm:grid grid-cols-2 gap-8 mt-4">
					<div>
						<label class="form-label" for="crud-form-1">Numéro de téléphone du conducteur</label>
						<div class="input-group">
							<select aria-label="Default select example" class="form-select input-group-text w-1/4">
								<option>{{ isoToEmoji("BJ") }}&nbsp;&nbsp;+229</option>
								<option>{{ isoToEmoji("NG") }}&nbsp;&nbsp;+234</option>
								<option>{{ isoToEmoji("TG") }}&nbsp;&nbsp;+228</option>
								<option>{{ isoToEmoji("GH") }}&nbsp;&nbsp;+233</option>
								<option>{{ isoToEmoji("CI") }}&nbsp;&nbsp;+225</option>
								<option>{{ isoToEmoji("BF") }}&nbsp;&nbsp;+226</option>
								<option>{{ isoToEmoji("NE") }}&nbsp;&nbsp;+227</option>
							</select>
							<input
								id="crud-form-1"
								class="form-control w-full"
...
<script setup>
	...
	import { isoToEmoji } from "@/helpers/utils.js";
