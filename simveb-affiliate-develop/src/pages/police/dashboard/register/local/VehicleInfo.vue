<template>
	<div class="col-span-12 mt-8">
		<Alert class="alert-outline-success bg-green-50 flex items-center mb-2 font-bold">
	...
	<div class="grid grid-cols-12 gap-6 mt-8 bg-white p-2 xl:p-4 rounded-md">
		<div class="col-span-12 py-3 px-8 bg-green-50 rounded-sm">
			<div class="intro-y flex items-center">
				<h2 class="text-2xl text-success">Informations du Véhicule</h2>
			</div>
		</div>
		...
		<div class="col-span-12 py-3 px-8 bg-green-50 rounded-sm">
			<div class="intro-y flex items-center">
				<h2 class="text-2xl text-success">Informations du propriétaire</h2>
			</div>
		</div>
		<div class="col-span-12 grid grid-cols-12 gap-6">
			<div class="col-span-12 lg:col-span-6 mx-2 lg:mx-9 intro-y">
		...
		<div class="col-span-12 py-3 px-8 bg-green-50 rounded-sm">
			<div class="intro-y flex items-center">
				<h2 class="text-2xl text-success">informations sur l’officier ayant enregistrer</h2>
			</div>
		</div>
		<div class="col-span-12 grid grid-cols-12 gap-6">
			<div class="col-span-12 lg:col-span-6 mx-2 lg:mx-9 intro-y">
				<div class="flex items-center pb-2 mt-2 border-b">
					<p class="w-1/2">Nom</p>
					<p class="font-bold text-dark w-1/2">KAKPO</p>
				</div>
				<div class="flex items-center pb-2 mt-6 border-b">
					<p class="w-1/2">Prénoms</p>
					<p class="font-bold text-dark w-1/2">Brice</p>
				</div>
				<div class="flex items-center pb-2 mt-6 border-b">
					<p class="w-1/2">Date de naissance</p>
					<p class="font-bold text-dark w-1/2">02/07/1998</p>
				...
				<div class="flex items-center pb-2 mt-6 border-b">
					<p class="w-1/2">Nationalité</p>
					<p class="font-bold text-dark w-1/2">Béninoise</p>
				</div>
				<div class="flex items-center pb-2 mt-6 border-b">
					<p class="w-1/2">Sexe</p>
					<p class="font-bold text-dark w-1/2">M</p>
	...
	<div class="intro-y col-span-12">
		<div class="text-right mt-4">
			...
			<button
				...
				type="button"
				@click="$router.push('/police/dashboard/register/local/OwnerInfo')"
			>
				Suivant
			</button>
		</div>
