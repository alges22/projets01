		...
		<Modal :show="successModalIsOpen" backdrop="static" @hidden="successModalIsOpen = false">
			<ModalBody class="p-0">
				<div class="p-5 text-center font-bold">
					<svg
						class="lucide lucide-check-circle w-16 h-16 text-warning mx-auto mt-3"
						fill="currentColor"
						height="24"
						stroke="white"
					...
					<div class="mt-2">Le dossier d'émission de gage est créé et attend la validation du greffier</div>
				</div>
				<div class="px-5 pb-8 text-center mt-4">
					<button class="btn btn-warning w-full mx-2 text-white" type="button" @click="closeModal">
						Ok, j'ai compris!
					</button>
				</div>
			</ModalBody>
...
<script setup>
	...
	const successModalIsOpen = ref(true);
	...
	const closeModal = () => {
		...
		router.push("/bank/pledge/VehicleInfo");
	};
</script>
