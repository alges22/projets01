	...
	<div class="content">
		<div class="top-bar -mx-4 px-4 md:mx-0 md:px-0 md:align-baseline mt-4">
			<nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
				<ol class="breadcrumb">
					<li class="breadcrumb-item">Tableau de bord / Concessionnaire - Parc</li>
				</ol>
			</nav>
		...
		<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
			<div class="w-full sm:w-auto flex mt-4 sm:mt-0 ml-auto">
				<button class="btn btn-outline-primary shadow-md mr-2">Ajouter un membre</button>
				<router-link class="btn btn-primary shadow-md mr-2" to="/parc/dashboard/ServiceType">
					Faire une demande
				</router-link>
			</div>
		</div>
