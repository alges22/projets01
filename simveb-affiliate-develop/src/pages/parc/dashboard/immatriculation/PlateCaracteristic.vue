	...
	<div class="grid grid-cols-12 gap-6 mt-5">
		<div class="intro-y col-span-12">
			...
			<div class="text-right mt-5">
				...
				<button class="btn btn-primary w-36" type="button" @click="modalIsOpen = true">Valider</button>
			</div>
		</div>

		<Modal :show="modalIsOpen" size="xl" @hidden="modalIsOpen = false">
			...
			<ModalBody class="grid grid-cols-12 gap-4 gap-y-3">
				<table class="table col-span-12 table-bordered">
					...
					<tfoot>
						<tr class="bg-[#E2E8F099]">
							<td colspan="3" class="font-bold">Total : 150 000 FCFA</td>
						</tr>
					</tfoot>
				</table>
			</ModalBody>
			<ModalFooter class="">
				<div class="flex mb-4">
					<button class="btn btn-outline-primary w-1/2 mr-4" type="button" @click="modalIsOpen = false">
						Plus tard
					</button>
					<button class="btn btn-primary w-1/2" type="button">Payer maintenant</button>
				</div>
			</ModalFooter>
		</Modal>
	</div>
