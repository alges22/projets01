<template>
	<div class="dropdown">
		<button
			...
			aria-expanded="false"
		>
			<i class="fa-light fa-filter me-1"></i> Filtres
...
<script setup>
	...
	/*const COLUMN_FILTERS = {
		number: ["equal", "not_equal", "less", "less_or_equal", "greater", "greater_or_equal", "between"],
		string: ["equal", "not_equal", "contains", "not_contains", "begins_with", "ends_with", "is_empty"],
		boolean: ["equal", "not_equal"],
		date: ["equal", "not_equal", "less", "less_or_equal", "greater", "greater_or_equal", "between"],
		datetime: ["equal", "not_equal", "less", "less_or_equal", "greater", "greater_or_equal", "between"],
		array: ["equal", "not_equal", "in", "not_in", "is_empty"],
