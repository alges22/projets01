<template>
	<template v-if="demand.userType">
		...
		<Recap
			...
			service="Demande d’immatriculation prestige numéro label"
			...
			<div class="col-span-12 grid grid-cols-12 gap-6">
				<div class="col-span-12 lg:col-span-6 mx-2 lg:mx-9 intro-y">
					<div class="flex items-center pb-2 mt-2 border-b">
						<p class="w-1/2 text-lg leading-5">Label choisie</p>
						<p class="font-bold text-dark w-1/2 text-lg leading-5 uppercase">
							{{ demand.label }}
						</p>
					</div>
					<div class="flex items-center pb-2 mt-2 border-b">
						<p class="w-1/2 text-lg leading-5">Numéro désiré</p>
						<p class="font-bold text-dark w-1/2 text-lg leading-5 uppercase">
							{{ demand.desired_number }}
						</p>
					</div>
				</div>
			</div>
