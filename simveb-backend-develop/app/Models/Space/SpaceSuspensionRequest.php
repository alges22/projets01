...
class SpaceSuspensionRequest extends Model implements CanFilterContract
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            $model->reference = 'SSR-' . now()->timestamp . strtoupper(Str::random(3));
        });
    }
    ...
    {
        return "Demande de suspension d'espace";
    }
}
