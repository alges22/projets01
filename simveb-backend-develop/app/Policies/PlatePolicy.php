...
class PlatePolicy
{
    ...
    {
        return $user->onlineProfile->hasPermissionTo('browse-plate');
    }
    ...
    {
        return $user->onlineProfile->hasPermissionTo('show-plate');
    }
    ...
    {
        return $user->onlineProfile->hasPermissionTo('store-plate');
    }
