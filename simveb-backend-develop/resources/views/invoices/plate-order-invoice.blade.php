...
<head>
    ...
    <title>Facture de commande de plaque | Simveb </title>
        ...
        <div>
            <table class="w-full table-fixed">
                <tr>
                    <td>
                        <div>
                            <div class="font-bold text-xl">Facture de commande de plaque</div>
                            <div>Référence: {{ $invoice->reference }}</div>
                        </div>
                    </td>
                    <td class="text-right">
                        <img src="{{ public_path('img/logo.png') }}" alt="logo.png">
                    </td>
                </tr>
            </table>
            ...
            <div class="mt-10">
                <table class="w-full table-auto">
                    <thead>
                        <tr class="border">
                            <th class="py-2">Forme de plaque</th>
                            <th class="border">Couleur de plaque</th>
                            <th class="border">Quantité</th>
                            <th class="border">Montant</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($invoice->model->order_details as $index => $detail)
