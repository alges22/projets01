<script setup>
    ...
    const { activeStep, loading, update, data_plates, vehicule_infos, label } = storeToRefs(store)
    ...
    onMounted(() => {
        ...
        api({
            ...
            .then((response) => {
                data_plates.value =  {
                    plate_color_id: response.demand.immatriculation_label.plate_color_id,
                    front_plate_shape_id: response.demand.immatriculation_label.front_plate_shape_id,
                    back_plate_shape_id: response.demand.immatriculation_label.back_plate_shape_id,
                }

                label.value = response.demand.immatriculation_label.label
