<script setup>
    ...
    const { activeStep, loading, update, data_plates, vehicule_infos, label, number } = storeToRefs(store)
    ...
    onMounted(() => {
        ...
        api({
            ...
            .then((response) => {
                ...
                label.value = response.demand.immatriculation.label
                number.value = response.demand.immatriculation.desired_number
