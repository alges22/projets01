<script setup lang="ts">
    ...
    useHead({
        title: 'SIMVEB - Inscriptionde l\'entreprise',
    })

    import Register from "~/components/register_entreprise_steps/Register.vue";
    import ProcessVerification from "~/components/register_entreprise_steps/ProcessVerification.vue";
    import InformationsConfirm from "~/components/register_entreprise_steps/InformationsConfirm.vue";
