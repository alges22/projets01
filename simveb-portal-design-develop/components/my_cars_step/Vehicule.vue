<script setup lang="ts">
    ...
    const { car: selectedCar } = storeToRefs(store);
...
<template>
    <div class="card w-full p-16 text-center mt-2">
        <div class="w-2/3 mx-auto">
            <span class="text-2xl text-blue-900 font-bold"> Choisissez le véhicule que vous voulez vendre et passer à l'action</span>
                    ...
                    <div
                        ...
                        <div class="w-1/5 flex justify-end">
                            <input
                                ...
                                type="radio" @change="selectedCar = car"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-right">
                <button class="btn btn-blue" :disabled="!selectedCar" @click="getToSaleDeclaration">Suivant</button>
            </div>
        </div>
    </div>
</template>
