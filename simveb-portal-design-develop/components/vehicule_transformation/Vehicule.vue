...
<template>
    <div class="card w-full p-16 text-center mt-2">
        <div class="w-2/3 mx-auto">
            <span class="text-2xl text-blue-900 font-bold"> Sélectionnez le véhicule que vous souhaitez transformer</span>
            ...
            <div class="text-right">
                <button class="btn btn-blue" :disabled="!selectedCar" @click="nextStep">Suivant</button>
            </div>
        </div>
    </div>
</template>
